            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/ayushvarma7/DataGuard" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-4 text-sm text-muted-foreground">
                        ...
                        <li><Link href="/dashboard/docs" className="hover:text-primary transition-colors">Documentation</Link></li>
                        <li><Link href="/dashboard" className="hover:text-primary transition-colors">Launch Dashboard</Link></li>
                        <li><Link href="https://github.com/ayushvarma7/DataGuard/blob/main/CONTRIBUTING.md" target="_blank" className="hover:text-primary transition-colors">Contributing</Link></li>
                    </ul>
                </div>
